...
df_IOS_revenue = df_DBM.iloc[lis_IOS].groupby(["Date"])
new_df_IOS["Impressions"] = df_IOS_revenue["Impressions"]
new_df_IOS["Clicks"] = df_IOS_revenue["Clicks"]
new_df_IOS["Revenue (Adv Currency)"] = df_IOS_revenue["Revenue (Adv Currency)"]
...
real_android_DBM = df_DBM[df_DBM["Insertion Order"].str.contains("Android")]
df_col_android = pd.merge(real_android_DBM, df_af_android_use, left_on = ['CM Placement ID', 'Date'], right_on = ['CM Placement ID', 'Date'], how = 'left')
...
real_IOS_DBM = df_DBM[df_DBM["Insertion Order"].str.contains("iOS")]
df_col_IOS = pd.merge(real_IOS_DBM, df_af_IOS_use, left_on = ['CM Placement ID', 'Date'], right_on = ['CM Placement ID', 'Date'], how = 'left')
...
real_Reeng_DBM = df_DBM[df_DBM["Insertion Order"].str.contains("New user")]
df_col_Reeng = pd.merge(real_Reeng_DBM, df_af_Reeng_use, left_on = ['CM Placement ID', 'Date'], right_on = ['CM Placement ID', 'Date'], how = 'left')
